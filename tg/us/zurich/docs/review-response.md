...
| 6 | CTA button not full-width on mobile | Subjective | Pill-style buttons with intrinsic padding are the design system standard (`_work-items/tg-design-system/`). Full-width CTAs are not the brand pattern. |
