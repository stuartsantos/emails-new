...
**Markets:** ae (UAE), at (Austria), be (Belgium), bh (Bahrain), ca (Canada), ch (Switzerland), cy (Cyprus), cz (Czech Republic), de (Germany), dk (Denmark), es (Spain), fr (France), gb (United Kingdom), gr (Greece), ie (Ireland), it (Italy), kw (Kuwait), lb (Lebanon), nl (Netherlands), no (Norway), nz (New Zealand), om (Oman), pt (Portugal), qa (Qatar), se (Sweden), sg (Singapore), us (United States)

**Multi-language countries:** Austria (de/en), Bahrain (en/ar), Belgium (en/fr/nl), Canada (en/fr), Switzerland (de/en/fr), Cyprus (en/el), Denmark (en/da), Greece (en/el), UAE (en/ar), Kuwait (en/ar), Norway (en/nb), Oman (en/ar), Qatar (en/ar), Sweden (en/sv)
